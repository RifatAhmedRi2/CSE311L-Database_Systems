...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2021 at 05:53 PM
...
(143, 'Randall', 'Matos', 'RMATOS', '121.123.5234', '2008-05-15', 'ST_CLERK', 2600.00, NULL, 124, 50),
...
(200, 'Jennifer', 'Whalem', 'JWHALEN', '515.123.4444', '2003-09-05', 'AD_ASST', 4400.00, NULL, 101, 10),
(201, 'Michael', 'Hartstein', 'MHARSTEIN', '515.123.5555', '2008-02-17', 'MK_MAN', 13000.00, NULL, 100, 20),
(202, 'Pat', 'Fay', 'PFAY', '603.123.6666', '2010-08-07', 'MK_REP', 6000.00, NULL, 201, 20),
...
CREATE TABLE `jobs` (
  ...
  `min_salary` int(8) DEFAULT NULL,
  `max_salary` int(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
